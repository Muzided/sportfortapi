...
import { adminLogin, createAdmin,adminCancelBookedTimeSlot, createGround, deleteGround, fetchGroundById, getAllGrounds, getBookings, updateGround } from "../controllers/adminController.js";
...
router.post('/cancel-booking/:id',adminCancelBookedTimeSlot)
router.post('/fetch-grounds', authenticateJWT, getAllGrounds);
